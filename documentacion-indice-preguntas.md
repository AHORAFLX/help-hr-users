# Sebastian HR — Índice de documentación por tareas ("¿Cómo hago esto?")


Etiqueta `PRO` = la pregunta solo aplica si la empresa tiene contratado el
modo PRO.
...
- ¿Cómo veo mis horas totales (ordinarias, extra, planificadas)? `PRO`
