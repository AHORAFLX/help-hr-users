...
Esta documentación reúne todo lo que puedes hacer por ti mismo en `Sebastian HR`:
fichar y revisar tu jornada, pedir vacaciones, consultar tus documentos y tu contrato,
enviar solicitudes a Recursos Humanos, apuntarte a cursos o reservar recursos de la
empresa.

Cada artículo está organizado por preguntas concretas, así que puedes ir directo a la
que necesites resolver. Si es tu primer día con la aplicación, empieza por la pantalla
de inicio y sigue el recorrido recomendado del final de esta página.
